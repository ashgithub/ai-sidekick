...
4. The bridge resolves shortcut profiles from `config/codex_web_panel.yaml`, including app context, soft nudge, review behavior, thread reuse, and polling policy.
